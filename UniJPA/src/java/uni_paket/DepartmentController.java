...
public class DepartmentController implements Serializable {
    ...
    @EJB
    private uni_paket.DepartmentFacade ejbFacade;
    ...
    public static class DepartmentControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Department) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + DepartmentController.class.getName());
            }
        }
    }
}
