...
public class StudentController implements Serializable {
    ...
    @EJB
    private uni_paket.StudentFacade ejbFacade;
    ...
    public static class StudentControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Student) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + StudentController.class.getName());
            }
        }
    }
}
